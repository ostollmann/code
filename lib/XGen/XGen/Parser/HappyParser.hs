...
happyReduction_4 (HappyTerminal (CChar happy_var_1))
	 =  HappyAbsSyn6
...
happyReduction_6 _
	(HappyTerminal (CChar happy_var_2))
	_
	 =  HappyAbsSyn6
		 ((\c -> case c of
                                                     'v' -> TVowel
...
happyReduction_8 (_ `HappyStk`
	(HappyTerminal (CChar happy_var_4)) `HappyStk`
	_ `HappyStk`
	(HappyTerminal (CChar happy_var_2)) `HappyStk`
	_ `HappyStk`
	happyRest)
	 = HappyAbsSyn6
...
happyReduction_10 (HappyTerminal (CChar happy_var_3))
	_
	(HappyTerminal (CChar happy_var_1))
	 =  HappyAbsSyn7
...
happyReduction_11 (HappyTerminal (CChar happy_var_3))
	_
...
happyNewToken action sts stk (tk:tks) =
	...
	CQuestion -> cont 11;
	CComma -> cont 12;
	CChar happy_dollar_dollar -> cont 13;
	_ -> happyError' (tk:tks)
	}
